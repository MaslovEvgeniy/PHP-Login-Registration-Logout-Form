                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php endif; ?>
                            <form id="register-form" name="registerForm" action="/register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select id="country" name="country" class="form-control" required>
                                    <?php foreach ($countries as $country): ?>
                                        <option value='<?= $country['id'] ?>' <?= isset($_POST['country']) && $country['id'] === $_POST['country'] ? 'selected' : '' ?>><?= $country['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group ">
